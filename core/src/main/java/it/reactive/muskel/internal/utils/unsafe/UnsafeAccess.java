...
/**
 * All use of this class MUST first check that UnsafeAccess.isUnsafeAvailable()
 * == true otherwise NPEs will happen in environments without "suc.misc.Unsafe"
 * such as Android.
 */
public final class UnsafeAccess {
	...
	try {
	     ...
	     * location:
	     * https://github.com/JCTools/JCTools/blob/master/jctools-core
	     * /src/main/java/org/jctools/util/UnsafeAccess.java
	     */
    ...
    /*
     * Methods below are utilities to offer functionality on top of Unsafe.
     * Several of these already exist in Java7/8 but we must support Java 6.
     */
    ...
    /**
     * Returns the address of the specific field on the class and wraps a
     * NoSuchFieldException into an internal error.
     * <p>
     * One can avoid using static initializers this way and just assign the
     * address directly to the target static field.
     * 
     * @param clazz
     *            the target class
     * @param fieldName
